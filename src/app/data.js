...
export const courses = [
  {
    ...
    icon: <FaCode color="#facc15" size={24} />,
  },
  {
    id: "java",
    title: "Java Full Stack",
    icon: <FaJava color="#f97316" size={24} />,
  },
  {
    id: "python",
    title: "Python Full Stack",
    icon: <FaPython color="#38bdf8" size={24} />,
  },
  {
    id: "mern",
    title: "MERN Full Stack",
    icon: <FaReact color="#22c55e" size={24} />,
  },
  {
    id: "php",
    title: "PHP Full Stack",
    icon: <FaPhp color="#a855f7" size={24} />,
  },
  {
    id: "fetch",
    title: "Fetch Data (Client)",
    icon: <FaCloudDownloadAlt color="#eab308" size={24} />,
  },
  {
    id: "server",
    title: "Fetch Data (Server)",
    icon: <FaServer color="#ec4899" size={24} />,
  },
];
